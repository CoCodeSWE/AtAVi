...
const rule = require('./stubs/RulesDAO');
...
describe('Back-end', function()
{
	describe('APIGateway', function()
	{
		...
		{
			let api = new VocalAPI(task, rule);
			describe('addRule', function ()
			{
				it('Se la risposta ricevuta dal microservizio Rules ha uno status code diverso da 200 allora il metodo deve sollevare un\'eccezione di tipo Exception con campo code pari allo status code della risposta.', function()
				{
					api.getRule()
				});
			});
