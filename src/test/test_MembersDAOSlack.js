...
describe('Back-end', function()
{
	describe('Members', function()
	{
		describe('MembersDAOSlack', function () 
		{
			...
			{
				it('L\'Observable deve notificare l\'Observer con il metodo complete solo dopo aver inviato tutti i blocchi di Member presenti nel database tramite il metodo next.');
